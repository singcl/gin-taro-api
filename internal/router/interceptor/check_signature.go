...
import (
	...
	"github.com/singcl/gin-taro-api/pkg/signature"
	"github.com/singcl/gin-taro-api/pkg/urltable"
)
...
func (i *interceptor) CheckSignature() core.HandlerFunc {
	return func(c core.Context) {
		...
		ok, err := signature.New(key, data.Secret, configs.HeaderSignTokenTimeout).
			Verify(authorization, date, c.Path(), c.Method(), c.RequestInputParams())
