...
import (
	...
	"github.com/singcl/gin-taro-api/internal/proposal/tablesqls"
...
type initExecuteRequest struct {
	...
	RedisDb   string `form:"redis_db" binding:"required"` // 连接 db

	MySQLAddr string `form:"mysql_addr"`
	MySQLUser string `form:"mysql_user" binding:"required"`
	MySQLPass string `form:"mysql_pass" binding:"required"`
